...
window.sendAiChatMessage = async function() {
  ...
  if (replyText) {
    ...
    } else if (lower.includes('pendidikan') || lower.includes('kuliah') || lower.includes('lulus') || lower.includes('skripsi') || lower.includes('undira')) {
      botDiv.innerHTML = `Steven merupakan alumni <strong>SMK Telkom Jakarta</strong> (Teknik Komputer Jaringan) dan <strong>Calon Lulusan S1 Teknik Informatika di Universitas Dian Nusantara (UNDIRA)</strong> yang dijadwalkan Sidang Skripsi pada Agustus 2026 (Expected Graduation: Agustus - September 2026)! 🎓`;
